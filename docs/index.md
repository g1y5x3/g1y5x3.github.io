...
<div class="column" markdown>
![ViGIR](assets/images/Missouri-S&T_PrimaryLogo_Forest_CMYK.png){: style="height: 3rem; float: right; margin-top: 1rem;" }
</div>
</div>
...
<div class="column" markdown>
![ViGIR](assets/images/vigir.jpg){: style="height: 3rem; float: right; margin-top: 1rem;" }
</div>
</div>
...
<div class="column" markdown>
![mizzou](assets/images/MU_logo.svg){: style="height: 3rem; float: right; margin-top: 1rem;" }
</div>
</div>
